...
async def get_ytdata():
  ...
  with YoutubeDL(youtube_dl_opts) as ydl:
      ...
      vidu_text = video_title.encode("utf-8")
      vid_text = vidu_text.decode('utf-8')
      ...
      data = {'data': [{'ID': video_id, 'Title': vid_text, 'Published': published_date, 'Duration': time, 'Views': view_count, 'Channel': channel, 'Categories': categories}],'Download_url':[{'audio': 'https://' + APP_NAME + '.herokuapp.com/audio?url='+video}],'Owned by':'DiyRex'}
